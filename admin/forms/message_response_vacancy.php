...
?>
    <body>
        <?php
           ...
           $db=new DB();
           $tblname='message_response_vacancy';
        ...
        ?>
                        ...
                        <div class="col-sm-10 add-bs" style="margin: 0 auto">
                            <div class="card stacked-form">
                                <div class="card-header ">
                                    <h4 class="card-title">Message response vacancy</h4>
                                </div>
                                <div class="container-message mt-4 ml-3 mr-3">
                                    <div class="cont-am mb-3">
                                        <div class="form-group">
                                            <label>Message. Response vacancy in armenian language.</label>
                                            <p class="text-danger mb-0">Do not change the name and vacancies glory in the text, and puts one space between glories.</p>
                                    ...
                                    <div class="cont-ru mb-3">
                                        <div class="form-group">
                                            <label>Message. Response vacancy in russian language.</label>
                                            <p class="text-danger mb-0">Do not change the name and vacancies glory in the text, and puts one space between glories.</p>
                                    ...
                                    <div class="cont-en mb-3">
                                        <div class="form-group">
                                            <label>Message. Response vacancy in english language.</label>
                                            <p class="text-danger mb-0">Do not change the name and vacancies glory in the text, and puts one space between glories.</p>
            ...
            <script src="../js/change-vacancy-text.js"> </script>
    </body>
</html>